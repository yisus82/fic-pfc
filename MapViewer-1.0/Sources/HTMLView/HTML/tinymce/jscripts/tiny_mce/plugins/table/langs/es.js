...
col_limit : 'Ha excedido el número máximo de columnas ({$cols}).',
row_limit : 'Ha excedido el número máximo de filas ({$filas}).',
cell_limit : 'Ha excedido el número máximo de celdas ({$celdas}).',
