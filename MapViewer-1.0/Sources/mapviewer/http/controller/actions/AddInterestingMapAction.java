...
public class AddInterestingMapAction extends DefaultAction {
	...
	try {
	    SessionManager.addInterestingMap(request, mapID);
	} catch (InstanceNotFoundException e) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
		    "ErrorMessages.mapID.notFound"));
	} catch (DuplicateInstanceException e) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
		    "ErrorMessages.mapID.duplicated"));
	} catch (AlreadyOwnedException e) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
		    "ErrorMessages.mapID.alreadyOwned"));
	}
