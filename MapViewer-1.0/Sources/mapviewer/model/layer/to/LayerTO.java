package mapviewer.model.layer.to;
...
public class LayerTO {
    ...
    /**
     * The identifier of the WMS the layer belongs to
     */
    private Long WMSID;

    /**
     * A constructor to create <code>LayerTO</code> objects.
     * 
     * @param layerID
     *                the identifier of the layer
     * @param title
     ...
     *                the identifier of the WMS the layer belongs to
     */
    public LayerTO(Long layerID, String title, String name, String styleTitle,
	    String styleName, Double minLatitude, Double minLongitude,
	    Double maxLatitude, Double maxLongitude, Long WMSID) {
	...
	if (obj instanceof LayerTO) {
	    LayerTO layer = (LayerTO) obj;
	    return (layer.getLayerID().equals(this.layerID)
		    ...
		    && layer.getTitle().equals(this.title) && layer.getWMSID()
		    .equals(this.WMSID));
	}
