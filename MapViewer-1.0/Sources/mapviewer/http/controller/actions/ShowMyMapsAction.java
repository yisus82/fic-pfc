...
public class ShowMyMapsAction extends DefaultAction {
	...
	/* Do show user maps. */
	return doShowMyMaps(mapping, userID, startIndex, count, request);
    }

    private ActionForward doShowMyMaps(ActionMapping mapping, String userID,
	...
	MapChunkTO maps;
	maps = searchFacadeDelegate.findMapsByUser(userID, startIndex, count);
	...
	return mapping.findForward("ShowMyMapsContent");
    }
