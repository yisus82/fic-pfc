 ...
 * <code>null</code> <code>ActionForward</code>, the action is not
 * executed, but instead the control is passed to the returned
 * <code>ActionForward</code>.
 */
public class MapViewerRequestProcessor extends TilesRequestProcessor {

    PreProcessingFilter firstPreProcessingFilter;

    public MapViewerRequestProcessor() {
	firstPreProcessingFilter = new SessionPreProcessingFilter(
	...
	ActionForward actionForward = firstPreProcessingFilter.process(request,
