...
public class ShowMyPOIsAction extends DefaultAction {
	...
	/* Do show user POIs. */
	return doShowMyPOIs(mapping, userID, startIndex, count, request);
    }

    private ActionForward doShowMyPOIs(ActionMapping mapping, String userID,
	...
	return mapping.findForward("ShowMyPOIsContent");
    }
