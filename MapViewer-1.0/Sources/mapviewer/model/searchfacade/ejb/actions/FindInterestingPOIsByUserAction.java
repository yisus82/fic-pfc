...
public class FindInterestingPOIsByUserAction {
    ...
    public FindInterestingPOIsByUserAction(EntityManager entityManager,
	...
	Query query = entityManager
		.createQuery(
			"SELECT u.interestingPOIs FROM UserProfile u WHERE u.userID = :userID")
