...
public class ShowMyWMSsAction extends DefaultAction {
	...
	/* Do show user WMSs. */
	return doShowMyWMSs(mapping, userID, startIndex, count, request);
    }

    private ActionForward doShowMyWMSs(ActionMapping mapping, String userID,
	...
	return mapping.findForward("ShowMyWMSsContent");
    }
