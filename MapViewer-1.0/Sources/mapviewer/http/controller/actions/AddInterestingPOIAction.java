...
public class AddInterestingPOIAction extends DefaultAction {
	...
	try {
	    SessionManager.addInterestingPOI(request, POIID);
	} catch (InstanceNotFoundException e) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
		    "ErrorMessages.POIID.notFound"));
	} catch (DuplicateInstanceException e) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
		    "ErrorMessages.POIID.duplicated"));
	} catch (AlreadyOwnedException e) {
	    errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
		    "ErrorMessages.POIID.alreadyOwned"));
	}
