...
public class FindMapsByUserAction {
    ...
    public FindMapsByUserAction(EntityManager entityManager, String userID,
	...
	Query query = entityManager.createQuery(
		"SELECT m FROM Map m WHERE m.user.userID = :userID "
			+ "ORDER BY m.name").setParameter("userID", userID);
