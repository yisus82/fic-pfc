...
public class FindWMSsByUserAction extends DefaultAction {
	...
	/* Do find WMSs by user. */
	return doFindWMSsByUser(mapping, userID, startIndex, count, request);
    }

    private ActionForward doFindWMSsByUser(ActionMapping mapping,
	...
	WMSChunkTO WMSs;
	WMSs = searchFacadeDelegate.findWMSsByUser(userID, startIndex, count);
	...
	return mapping.findForward("FindWMSsByUserContent");
    }
